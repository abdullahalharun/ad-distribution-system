                ...
                <div class="col-12">
                    <div class="card">
                        ...
                        <div class="card-content">
                            <div class="card-body">
                                <form action="{{ route('advertisement-size.store') }}" method="POST" class="form">
                                    @csrf
                                    <div class="row">
                                        <div class="col-md-6 col-12">
                                            <div class="form-group">
                                                <label for="first-name-column">Column</label>
                                        ...
                                        <div class="col-md-6 col-12">
                                            <div class="form-group">
                                                <label for="email-id-column">Inch</label>
                                                <input type="text" id="email-id-column" class="form-control"
                                                    name="inch" placeholder="">
                                            </div>
                                        </div>
